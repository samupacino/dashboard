...
function onClickEditar(fila, boton, tr, rowApi) {              // [APP] Tu función para editar
	...
	document.getElementById('tag_editar').value = data.tag;
	document.getElementById('plataforma_editar').value = data.plataforma;
...
function mostrarMensajeEnModalRegistro(texto, tipo = "success") {
...
// Función que devuelve un manejador de modal "privado"
function mostrarSuccessT1155(mensaje) {
